...
class UITree extends Component {
  ...
  constructor(props) {
    ...
    this.state.handleToogleCollapse = this.props.handleToogleCollapse;
  }
  ...
  dragEnd = () => {
    ...
    const draggedIndex = tree.getIndex(dragging.id);
    const draggedNodeParent = draggedIndex && draggedIndex.parent ? tree.getIndex(draggedIndex.parent).node : null;
    ...
    if (draggedIndex)
      this.nodeDragged(draggedIndex.node, draggedNodeParent);
    this.change(tree);
  ...
  nodeDragged = (draggedNode, draggedNodeParent) => {
    if (this.props.onNodeDragged)
      this.props.onNodeDragged(draggedNode, draggedNodeParent);
  };
  ...
  toggleCollapse = nodeId => {
    ...
    if (this.state.handleToogleCollapse)
      this.state.handleToogleCollapse(node);
